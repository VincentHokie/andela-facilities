...
class Occupants extends Base {
  render() {
    return (
      <div>
        <h1 className="title is-4">Occupants</h1>
        <h2 className="subtitle is-6">You can use this page to manage occupants and see a history of occupation in Andela Spaces.</h2>
        <table className="table" >
          <thead>
            <tr>
              ...
              <th><abbr title="Played">Entry Date</abbr></th>
              <th><abbr title="Played">Exit Date</abbr></th>
              <th>Edit</th>
              <th>Delete</th>
            </tr>
          </thead>
